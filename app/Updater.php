...
class Updater {
	...
	public function __construct() {
		$this->plugin_slug   = 'anchor-blocks';
		$this->version       = ANCHOR_BLOCKS_VERSION;
		$this->cache_key     = 'anchor_blocks_updater';
	...
	public function request() {
		...
		if ( false === $remote || ! $this->cache_allowed ) {
			$remote_response = wp_remote_get(
				'https://raw.githubusercontent.com/anchorhost/anchor-blocks/main/manifest.json',
				[
					'timeout' => 30,
